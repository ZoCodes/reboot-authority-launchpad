      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-3 text-reboot-navy">Performance Dashboard</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-3 text-reboot-navy">Optional Boosters</h3>
            <p>Content, CRO, GEO audits, technical SEO fixes, and more.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-3 text-reboot-navy">Regular Strategy Reviews</h3>
        ...
        <div className="mt-16 bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-4 flex items-center text-reboot-navy">
